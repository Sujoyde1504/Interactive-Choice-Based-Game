...
$page_name = "scene2.2.php";  // This can be any dynamic or static name
...
<body>
    ...
    <script>
        var flag = 0;
        const dialogues = [
            { text: "Rodrick, this is Isara River. You’ve heard the stories, haven’t you? This river isn’t something you take lightly. It’s wild, unpredictable. The currents are like nothing you've ever seen", speakerImage: "character1.png" },
            { text: "It’s not just the strength of the river you need to worry about. It’s the depths. There are whirlpools that drag you down before you even know it. And the rocks below the surface? Sharp enough to tear your skin open.", speakerImage: "character1.png" },
            { text: "They say it’s cursed, that the waters are alive, pulling you deeper if you’re not careful. No one’s ever crossed it easily, mainly because of damn rocks", speakerImage: "character1.png", flag: 1 }
        ];
